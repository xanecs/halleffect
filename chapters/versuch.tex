...
\begin{figure}[H]
\centering
\csvreader[tabular=cc, table head=Querstrom $I_Q$ in \SI{}{\milli\ampere} & Hallspannung $U_H$ in \SI{}{\milli\volt}\\\Xhline{4\arrayrulewidth}, late after line=\\\hline]{data/germanium.dat}{}{\num{\csvcoli} & \num{\csvcolii}}
